...
trainer.save_model("./vanilla-bert-pubmedqa-finetuned")
tokenizer.save_pretrained("./vanilla-bert-pubmedqa-finetuned")
print("\nModel saved to './vanilla-bert-pubmedqa-finetuned'")
